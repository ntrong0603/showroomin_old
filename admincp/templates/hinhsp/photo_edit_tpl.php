...
<form name="frm" method="post" action="index.php?com=hinhsp&id_com=<?php echo $_GET['id_com'];?>&act=save_photo&id=<?php echo $_REQUEST['id'];?>&idc=<?php echo $_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">
    ...
    <br />
	<b>Hình ảnh </b> <input type="file" name="file" /> <strong> 400 * 500.jpg|.gif|png</strong><br />
