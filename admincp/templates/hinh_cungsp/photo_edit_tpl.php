...
<form name="frm" method="post" action="index.php?com=hinh_cungsp&act=save_photo&id=<?php echo $_REQUEST['id'];?>&id_sp=<?php echo $id_sp;?>" enctype="multipart/form-data" class="nhaplieu">
