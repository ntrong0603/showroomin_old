...
<div class="footer-container">
    ...
    <div class="company-info left">
            <?=$company_foot['noidung_vi']?>
    </div>
    <div class="share left">
        <a href="fb.html" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=<?=getCurrentPageURL()?>', 'newwindow', 'width=900, height=250'); return false;"> 
        <span class="share-button fb"></span>
        </a>
        <a href="gg.html" onclick="window.open('https://plus.google.com/share?url=<?=getCurrentPageURL()?>', 'newwindow', 'width=900, height=250'); return false;"> 
        <span class="share-button gg"></span>
        </a>
        <a href="tt.html" onclick="window.open('http://twitter.com/share?url=<?=getCurrentPageURL()?>', 'newwindow', 'width=900, height=250'); return false;">  
        <span class="share-button twt"></span>
        </a>     
        <a href="tt.html" onclick="window.open('http://www.linkedin.com/sharer.php?u=<?=getCurrentPageURL()?>', 'newwindow', 'width=900, height=250'); return false;"> 
        <span class="share-button linkedin"></span> 
        </a>
        <a href="tt.html" onclick="window.open('https://myspace.com/Modules/PostTo/Pages/?l=3&u=<?=getCurrentPageURL()?>', 'newwindow', 'width=900, height=250'); return false;"> 
