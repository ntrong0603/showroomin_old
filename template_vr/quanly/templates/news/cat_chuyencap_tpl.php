...
<?php	
	...
	{
		global $loaitin;
		$sql_huyen="select * from table_product_cat where loaitin='".$loaitin."' order by stt,id desc ";
	...
	{
		global $loaitin;
		$sql_huyen="select * from table_product_item where loaitin='".$loaitin."' order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
