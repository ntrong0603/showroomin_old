...
<form name="frm" method="post" action="index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=save_list&id=<?=@$item['id']?>" enctype="multipart/form-data" class="nhaplieu">	    	    <b>Danh mục cấp 1:</b><?=get_main_danhmuc();?><br /><br /> 
	...
	{?>
	<b>Hình ảnh đại diện:</b><img src="<?=_upload_tintuc.$item['thumb']?>"  alt="NO PHOTO" width="200px;" /><br />
	<?php }?>
