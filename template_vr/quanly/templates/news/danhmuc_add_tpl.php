...
<form name="frm" method="post" action="index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=save_danhmuc&id=<?=@$item['id']?>" enctype="multipart/form-data" class="nhaplieu">	
	...
	<?php }?>
	<b>Chọn hình đại diện:</b> <input type="file" name="file" /> <?=_news_type?><br />
    <br />
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=man_danhmuc'" class="btn" />
</form>