...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=doitac&act=delete_photo&listid=" + listid;
});
});
</script>

<h3><a href="index.php?com=doitac&act=add_photo">Thêm hình ảnh ( Kích thước 200 x 200 )</a></h3>
...
<a href="index.php?com=doitac&act=add_photo&idc=<?=$_REQUEST['idc'];?>"><img src="media/images/add.jpg" border="0"  /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="xoahet"><img src="media/images/delete.jpg" border="0"  /></a>
