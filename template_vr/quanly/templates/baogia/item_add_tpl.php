...
<form name="frm" method="post" action="index.php?com=baogia&act=save&curPage=<?php echo $_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
...
<!--     <b>Nội dung - English</b><br/>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=baogia&act=man'" class="btn" />
</form>