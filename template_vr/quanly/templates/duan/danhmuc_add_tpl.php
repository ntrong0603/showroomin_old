...
<form name="frm" method="post" action="index.php?com=duan&act=save_danhmuc&id=<?php echo @$item['id'];?><?php 
for($i=1;$i<=$sodmuc;$i++)
{
...
?>" enctype="multipart/form-data" class="nhaplieu">	
	...
	{?>
	<b>Icon:</b><img src="<?php echo "../upload/duan".$item['thumb']?>"  alt="NO PHOTO" width="200px;" /><br />
	<?php }?>
    ...
    <?php if ($_REQUEST['act']=='edit_danhmuc')
	{?>
	<b>Hình đại diện:</b><img src="<?php echo "../upload/duan".$item['thumb2']?>"  alt="NO PHOTO" width="200px;" /><br />
	<?php }?>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=duan&act=man_danhmuc'" class="btn" />
</form>