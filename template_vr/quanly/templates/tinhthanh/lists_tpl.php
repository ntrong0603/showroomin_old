...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=product&act=delete_list&listid=" + listid;
});
});
</script>
<h3>Quản lý danh mục cấp 2</h3>
 ...
 <script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=product&act=man_list&id_danhmuc="+a.value;	
		return true;
	}
</script>
...
<table class="blue_table">
    ...
    <td style="width:5%;" align="center"><input type="checkbox" name="chon" id="chon" value="<?=@$items[$i]['id']?>" class="chon" /></td>
		...
		<td style="width:5%;"><a href="index.php?com=product&act=edit_list&id_danhmuc=<?=@$items[$i]['id_danhmuc']?>&id=<?=@$items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a></td>
		<td style="width:5%;"><a href="index.php?com=product&act=delete_list&id=<?=@$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?=@$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
	</tr>
	<?php	}?>
</table>
