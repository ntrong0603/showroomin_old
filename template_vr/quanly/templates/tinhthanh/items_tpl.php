	...
	<?php if ($capmenu>=2){ ?>	<td style="width:10%;">
      ...
      <?php if ($capmenu>=4){ ?>  <td style="width:10%;">
       ...
       <?php  } ?>
        ...
        <td style="width:10%;"><a href="index.php?com=product&act=edit&id_danhmuc=<?=@$items[$i]['id_danhmuc']?>&id_list=<?=@$items[$i]['id_list']?>&id_cat=<?=@$items[$i]['id_cat']?>&id_item=<?=@$items[$i]['id_item']?>&id=<?=@$items[$i]['id']?>" style="text-decoration:none;"><?=@$items[$i]['ten']?></a></td>
        
       <td align="center" style="width:8%;"><a href="index.php?com=hinhsp&act=man_photo&id_sp=<?=@$items[$i]['id']?>">Hình ảnh</a></td>
        ...
        <a href="index.php?com=product&act=man&noibat=<?=@$items[$i]['id']?>"><img src="media/images/active_1.png" border="0" /></a>
		<? 
		}
		else
		{
		?>
         <a href="index.php?com=product&act=man&noibat=<?=@$items[$i]['id']?>"><img src="media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>     
        </td>
        ...
        <a href="index.php?com=product&act=man&hienthi=<?=@$items[$i]['id']?>"><img src="media/images/active_1.png" border="0" /></a>
		<? 
		}
		else
		{
		?>
         <a href="index.php?com=product&act=man&hienthi=<?=@$items[$i]['id']?>"><img src="media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>      
        </td>
        
		<td style="width:5%;"><a href="index.php?com=product&act=edit&id_danhmuc=<?=@$items[$i]['id_danhmuc']?>&id_list=<?=@$items[$i]['id_list']?>&id_cat=<?=@$items[$i]['id_cat']?>&id_item=<?=@$items[$i]['id_item']?>&id=<?=@$items[$i]['id']?>"><img src="media/images/edit.png" /></a></td>
		<td style="width:5%;"><a href="index.php?com=product&act=delete&id=<?=@$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?=@$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
