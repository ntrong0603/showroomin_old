...
<form name="frm" method="post" action="index.php?com=mathangkinhdoanh&act=save&curPage=<?php echo $_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=mathangkinhdoanh&act=man'" class="btn" />
</form>
