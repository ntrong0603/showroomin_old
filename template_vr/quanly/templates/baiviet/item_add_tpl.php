...
<form name="frm" method="post" action="index.php?com=baiviet&act=save&p=<?php echo $_REQUEST['p']?>" enctype="multipart/form-data" class="nhaplieu">	 
	 <div id='tab1' class='' > 
	 <b>Tên </b> <input type="text" name="ten" value="<?php echo @$item['ten']?>" class="input" /><br /> 
	 <b>loại tin</b> <input type="text" name="loaitin" value="<?php echo @$item['loaitin']?>" class="input" /><br /> 
