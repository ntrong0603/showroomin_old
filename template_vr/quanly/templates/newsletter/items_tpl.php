...
<table class="blue_table">
	...
	<tr>
		...
		<td style="width:5%;"><a href="index.php?com=newsletter&act=delete&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
	</tr>
	<?php	}?>
</table>
