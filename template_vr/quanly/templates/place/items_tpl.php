...
<script language="javascript">				
	...
	?>
		...
		{	
			<?php 
				$url='"index.php?com=place&act='.$_GET['act'];
	...
	$(document).ready(function(){   
		$('.kichthuoc').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/place/ajax/ajaxkichthuoc.php",
		...
		$('.gia').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/place/ajax/ajaxgia.php",
				data:"idsp="+idsp+"&idstt="+idmaso,
				async:false,
				success:function(kq){
		...
		$('.stt').focusout(function(){
			...
			$.ajax({
				...
				data:"idsp="+idsp+"&idstt="+idmaso+"&table=place",
				async:false,
				success:function(kq){
				}
			})
...
?>
<a href="index.php?com=place&act=add"><img src="./../../quanly/media/images/add.jpg" border="0"  /></a>
<br />
<table class="blue_table">
	<tr>
        ...
        <th style="width:5%;">Địa điểm</th>
        <th style="width:5%;">Hình  </th>
         <th style="width:5%;">Các hình sản phẩm</th>
         <th style="width:5%;">Quản lý tin tức</th>
		 <th style="width:5%;">Quản lý danh mục</th>
		<th style="width:5%;">Quản lý sản phẩm</th>
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
        ...
        <td style="width:5%;"><a href="index.php?com=place&act=edit&<?php 
         ...
         <td align="center" style="width:5%;"><?php echo $items[$i]['diadiem'] ?></td>
       ...
       <td align="center" style="width:5%;"><a href="index.php?com=news&loaitin=gioithieu&act=man&id_place=<?=@$items[$i]['id']?>"><img src="./../../quanly/media/images/folder.png"  border="0" width="50px" /></a></td>	
  <td align="center" style="width:5%;"><a href="index.php?com=product&act=man_danhmuc&id_place=<?=@$items[$i]['id']?>"><img src="./../../quanly/media/images/folder.png"  border="0" width="50px" /></a></td>
		<td align="center" style="width:5%;"><a href="index.php?com=product&act=man&id_place=<?=@$items[$i]['id']?>"><img src="./../../quanly/media/images/folder.png"  border="0" width="50px" /></a></td>	
        ...
        <a href="index.php?com=place&act=man&<?php 
			...
			?>noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="./../../quanly/media/images/active_1.png" border="0" /></a>
		<?php }
		else
		{
		?>
         <a href="index.php?com=place&act=man&<?php 
			...
			?>noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="./../../quanly/media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>     
        </td>
        ...
        <a href="index.php?com=place&act=man&<?php 
			...
			?>hienthi=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="./../../quanly/media/images/active_1.png" border="0" /></a>
		<?php }
		else
		{
		?>
         <a href="index.php?com=place&act=man&<?php 
			...
			?>hienthi=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="./../../quanly/media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>      
        </td>
        
		<td style="width:5%;"><a class='edit_item' href="index.php?com=place&act=edit&<?php 
			...
			?>id=<?php echo @$items[$i]['id']?><?php if( isset( $_GET['p'] ) ){echo "&p=".$_GET['p'];}?>"><img src="./../../quanly/media/images/edit.png" /></a></td>
		<td style="width:5%;"><a href="index.php?com=place&act=delete&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$items[$i]['ten']?>')) return false;"><img src="./../../quanly/media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
<a href="index.php?com=place&act=add"><img src="./../../quanly/media/images/add.jpg" border="0"  /></a>
