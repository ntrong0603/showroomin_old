<script language="javascript">			
	...
	{		
		...
		window.location ="index.php?com=chothue&act=<?php if($_REQUEST['act']=='edit_list2') echo 'edit_list2'; else echo 'add_list2';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_list="+b.value;	
		return true;
	}
...
function get_main_list()
	{
		$sql="select * from table_chothue_list0 order by id asc";
...
<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=chothue&act=save_list2" enctype="multipart/form-data" class="nhaplieu">	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=chothue&act=man_list2'" class="btn" />
</form>