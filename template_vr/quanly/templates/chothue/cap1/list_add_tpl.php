<h3>Thêm danh mục</h3>
<form name="frm" method="post" action="index.php?com=chothue&act=save_list0" enctype="multipart/form-data" class="nhaplieu">
	...
	<?php }?>
	<b>Hình ảnh:</b> <input type="file" name="file" /> <?php echo _chothue_type?> - <span style="font-weight:bold; color:red"></span><br />
    <br />
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=chothue&act=man_list0'" class="btn" />
</form>