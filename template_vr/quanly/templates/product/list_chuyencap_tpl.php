...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=place&act=chuyencap_list&id_list="+a.value;	
		return true;
	}
	...
	{			
		...
		window.location ="index.php?com=place&act=chuyencap_list&id_list="+a.value+"&id_cat="+b.value;	
		return true;
	}
...
<?php	
	...
	{
		$sql_huyen="select ten,id from table_place_list order by stt,id desc ";
	...
	{
		$sql_huyen="select ten,id from table_place_cat order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
...
?>
<form name="frm" method="post" action="index.php?com=place&act=save_chuyencap_list" enctype="multipart/form-data" class="nhaplieu">
