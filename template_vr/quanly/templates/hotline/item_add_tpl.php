...
<form name="frm" method="post" action="index.php?com=hotline&act=save" enctype="multipart/form-data" class="nhaplieu">	
    ...
    <b>Tên công ty tiếng Anh:</b> <input type="text" name="ten_sd" value="<?=@$item['ten_sd']?>" class="input" /><br /> 
    <b>Tiêu đề website:</b> <input type="text" name="site_title" value="<?=@$item['site_title']?>" class="input" /><br />
    <b>Tiêu đề website tiếng Anh:</b> <input type="text" name="site_title_sd" value="<?=@$item['site_title_sd']?>" class="input" /><br />
    ...
    <b>Facebook: </b> <input type="text" name="facebook" value="<?=@$item['facebook']?>" class="input" /><br />	
