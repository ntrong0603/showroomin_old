...
<form name="frm" method="post" action="index.php?com=haicot&act=save_list&id=<?php echo @$item['id'];?>" enctype="multipart/form-data" class="nhaplieu">	    	    <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /> 
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=haicot&act=man_list'" class="btn" />
</form>