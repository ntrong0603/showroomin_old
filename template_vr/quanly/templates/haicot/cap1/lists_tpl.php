<h3><a href="index.php?com=haicot&act=add_list0">Thêm danh mục</a></h3><font color="#FF0000"><b>
...
<table class="blue_table">
	...
	<tr>
		...
		{
		?>
			<a href="index.php?com=haicot&act=man_list0&hienthi=<?php echo $items[$i]['id']?>"><img src="media/images/active_1.png"  border="0"/></a>
		<?php
		}
		else
		{
		?>
			<a href="index.php?com=haicot&act=man_list0&hienthi=<?php echo $items[$i]['id']?>"><img src="media/images/active_0.png" border="0" /></a>
         <?php
		 }?>
		...
		<td style="width:5%;">
			<a href="index.php?com=haicot&act=edit_list0&id=<?php echo $items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a>
		</td>
		
		<td style="width:5%;">
			<a href="index.php?com=haicot&act=delete_list0&id=<?php echo $items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;">
...
<a href="index.php?com=haicot&act=add_list0"><img src="media/images/add.jpg" border="0"  /></a>
