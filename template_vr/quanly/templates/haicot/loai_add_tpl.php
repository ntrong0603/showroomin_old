...
<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=haicot&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if( isset($_REQUEST['id']) and $_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_danhmuc="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=haicot&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if( isset($_REQUEST['id']) and $_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
...
<?php	
	...
	{
		$sql_huyen="select * from table_haicot_cat where id_list=".$_REQUEST['id_list']." order by stt,id desc ";
...
<form name="frm" method="post" action="index.php?com=haicot&act=save_item&id=<?php echo @$item['id'];?>" enctype="multipart/form-data" class="nhaplieu">	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=haicot&act=man_item'" class="btn" />
</form>