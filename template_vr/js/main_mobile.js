	...
	function tengianhang(id){
		$.ajax({
			url : './../../template_vr/sources_mobile/ten_gianhang_ajax.php',
			type : 'post',
			dataType : 'text',
			data:{
				id: id,
	...
	function sp_gianhang(id){
		$.ajax({
			url : './../../template_vr/sources_mobile/gianhang_ajax.php',
			type : 'post',
			dataType : 'text',
			data:{
				id: id,
	...
	function get_info_sp(id){
		$.ajax({
			url : './../../template_vr/sources_mobile/chitietsanpham.php',
			type : 'post',
			dataType : 'text',
			data:{
				id: id,
	...
	function uploadgiohang(){
		...
		$.ajax({
			url : './../../template_vr/sources_mobile/giohang_ajax.php',
			type : 'post',
			dataType : 'text',
			data:{
				mobile: mobile
	...
	function uploadgiohang2(){
		var mobile="<?php echo $mobile;?>";
		$.ajax({
			url : './../../template_vr/sources_mobile/giohang2_ajax.php',
			type : 'post',
			dataType : 'text',
			data:{
				mobile: mobile
	...
	$( document ).ready(function(){
		...
		$("#thongtinchitietsp").on("click",".mau3d", function(e){
			...
			mau3d(data.id);
			$.ajax({
				url : './../../template_vr/sources_mobile/mau3d_ajax.php',
				type : 'post',
				dataType : 'text',
				data:{
					idsp: data.id
