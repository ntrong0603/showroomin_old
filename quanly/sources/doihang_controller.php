...
function get_gioithieu(){
	...
	$sql = "select * from #_about where id = 5 limit 0,1";
	$d->query($sql);
...
function save_gioithieu(){
	...
	if(empty($_POST)) transfer("Không nhận được dữ liệu", "index.php?com=doihang&act=capnhat");
	...
	// print_r($data);die();
	if($d->update($data))
		transfer("Dữ liệu được cập nhật", "index.php?com=doihang&act=capnhat");
	else
		transfer("Cập nhật dữ liệu bị lỗi", "index.php?com=doihang&act=capnhat");
}
