...
$config['database']['username'] = 'phattrienanhvie';
$config['database']['password'] = 'NDf0cX8YXoy';
$config['database']['database'] = 'phattrienanhvie';
...
class database{
    ...
    function setWhereNotEqual($key, $value=""){
        if($value!=""){
            if($this->where == "")
                $this->where = " where " . $key . " != '" . $value . "'";
            else
    ...
    function setWhereLessThan($key, $value=""){
        if($value!=""){
            if($this->where == "")
                $this->where = " where " . $key . " < '" . $value . "'";
            else
    ...
    function setWhereMoreThan($key, $value=""){
        if($value!=""){
            if($this->where == "")
                $this->where = " where " . $key . " > '" . $value . "'";
            else
