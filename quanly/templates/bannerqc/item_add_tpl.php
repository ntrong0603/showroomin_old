...
-->	
	...
	<input type="text" name="ten" value="<?php echo @$item['ten']?>" class="input" />
	<br />
    <?php
	...
	{?>
	<b>Hình hiện tại:</b><img src="<?php echo _upload_video.$item['image']?>" alt="NO PHOTO"  width="237" height="160"/>
