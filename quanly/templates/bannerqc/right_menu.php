<?php
	#================================= san pham nổi bật 
	$d->reset();
	$sql_sp_noibat = "select * from #_place  where spdc!=0 and hienthi=1 order by spdc asc  limit 0,10";
    ...
    <div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <a href="#"><img src="<?php echo _upload_sanpham_l.$row_sp_noibat[$i]['photo']?>" width="155" height="113"  border="0" /></a>
                        <br />
                  ...
                  <tr>
                    <td height="26" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="166" align="left" class="left-menu"><a href="index.php?com=news&id=<?php echo $row_tinnoibat[$i]['id']?>">
                            
                           <?php echo $row_tinnoibat[$i]['ten']?>
                    ...
                    <td height="26" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    	...
                    	<tr>
                          ...
                          <tr>
                           ...
                           <?php echo $row_hotline[0]['dienthoai']?>
