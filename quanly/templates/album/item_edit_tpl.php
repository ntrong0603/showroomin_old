...
<form name="frm" method="post" action="index.php?com=album&act=save_item&id=<?php echo $_REQUEST['id'];?>&idc=<?php echo $_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">
	<b>Tên Album</b>  <input type="text" name="ten" value="<?php echo @$item['ten']?>" style="width:200px" />  <br />
	<b>&nbsp;</b> 
    
        <img src="<?php echo _upload_album.$item['photo']?>" width="200" />
