...
<font color="#FF0000" size="5"><b>  Kích thước bắt buộc: Rộng:1200x200</b></font>
<table class="blue_table" style="margin-top:10px;">
	...
	<tr>
       ...
       <img src="<?php echo _upload_slideshow.$items[$i]['photo']?>"  height="100" />
		...
		<td style="width:5%;"><a href="index.php?com=slideshow&act=edit_photo&id=<?php echo $items[$i]['id']?>"><img src="media/images/edit.png" border="0" /></a></td>
        <td style="width:5%;"><a href="index.php?com=slideshow&act=delete_photo&id=<?php echo $items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
	</tr>
	<?php	}?>
</table>
