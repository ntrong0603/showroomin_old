...
<script language="javascript">				
	...
	$(document).ready(function(){   
		$('.kichthuoc').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/duan/ajax/ajaxkichthuoc.php",
		...
		$('.gia').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/duan/ajax/ajaxgia.php",
				data:"idsp="+idsp+"&idstt="+idmaso,
				async:false,
				success:function(kq){
		...
		$('.stt').focusout(function(){
			...
			$.ajax({
				...
				data:"idsp="+idsp+"&idstt="+idmaso+"&table=duan",
				async:false,
				success:function(kq){
				}
			})
...
?>
<a href="index.php?com=duan&act=add"><img src="media/images/add.jpg" border="0"  /></a>
<br />
<table class="blue_table">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
        ...
        <td style="width:5%;"><a href="index.php?com=duan&act=edit&<?php 
       ...
       <td align="center" style="width:5%;"><img src="<?php echo "../upload/duan/".$items[$i]['thumb'] ?>" style="max-width:80%"/></td>
       <td align="center" style="width:5%;"><a href="index.php?com=hinhsp&act=man_photo&id_sp=<?php echo @$items[$i]['id']?>&id_com=<?php echo $_GET['com'];?>">Hình ảnh</a></td>
        ...
        <a href="index.php?com=duan&act=man&<?php 
		...
		<td style="width:5%;"><a class='edit_item' href="index.php?com=duan&act=edit&<?php 
		...
		<td style="width:5%;"><a href="index.php?com=duan&act=delete&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
<a href="index.php?com=duan&act=add"><img src="media/images/add.jpg" border="0"  /></a>
