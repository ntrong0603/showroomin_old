...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=duan&act=chuyencap_cat&id_cat="+a.value;	
		return true;
	}
...
<?php	
	...
	{
		$sql_huyen="select * from table_duan_cat order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=duan&act=save_chuyencap_cat" enctype="multipart/form-data" class="nhaplieu">
