...
$(document).ready(function() {
	$('.stt').focusout(function(){
		...
		$.ajax({
				...
				data:"idsp="+idsp+"&idstt="+idmaso+"&table=duan_category",
				async:false,
				success:function(kq){
				}
		})
...
$("#xoahet").click(function(){
	...
	if (hoi==true) document.location = "index.php?com=duan&act=delete_danhmuc&listid=" + listid;
});
});
</script>
...
<form action style="margin: 20px 0px;" method="GET">
	...
	<a href="index.php?com=duan&act=man_danhmuc" style="text-decoration: none; border:solid 1px #cccccc; padding:3px;">Reset</a>
</form>
<script>
...
<table class="blue_table">
	...
	<?php for($i=0, $count=count($items); $i<$count; $i++){
		...
		<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
	        ...
	        <td style="width:10%;">
				<img src="<?php echo "../upload/duan".@$items[$i]['thumb2'];?>" width="60px">
	        </td>	
	        <td style="width:5%;">
			<?php 
			...
			<td style="width:5%;"><a href="index.php?com=duan&act=edit_danhmuc&<?php 
			...
			<td style="width:5%;"><a href="index.php?com=duan&act=delete_danhmuc&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
		</tr>
		<?php if(!empty($items[$i]['sub'])){ show_sub($items[$i]['sub']); }?>
	<?php	}?>
</table>
<a href="index.php?com=duan&act=add_danhmuc"><img src="media/images/add.jpg" border="0"  /></a>
...
?>	
		<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
			...
			<td style="width:5%;"><a href="index.php?com=duan&act=delete_danhmuc&id=<?php echo @$sub[$j]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$sub[$j]['ten']?>')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
		</tr>
<?php
		$d1=$d+2;
		if(!empty($sub[$j]['sub'])){ 
