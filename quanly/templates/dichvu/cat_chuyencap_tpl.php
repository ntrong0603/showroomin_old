...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=dichvu&act=chuyencap_cat&id_cat="+a.value;	
		return true;
	}
...
<?php	
	...
	{
		$sql_huyen="select * from table_dichvu_cat order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=dichvu&act=save_chuyencap_cat" enctype="multipart/form-data" class="nhaplieu">
