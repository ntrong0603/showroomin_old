...
<form name="frm" method="post" action="index.php?com=thuoctinh&id=<?php echo @$item['id']?>&loaitin=<?php echo $loaitin; ?>&act=save&p=<?php echo $_REQUEST['p']?>" enctype="multipart/form-data" class="nhaplieu">	 
	 <div id='tab1' class='' > 
	...
	<?php }?>
	<b>Chọn hình:</b> <input type="file" name="file" /> <?php echo _thuoctinh_type?><br />
    <br />
