...
<form name="frm" method="post" action="index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=save_list" enctype="multipart/form-data" class="nhaplieu">	    	    <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /> 
