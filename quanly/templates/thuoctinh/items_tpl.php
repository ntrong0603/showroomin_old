...
<h3>Quản lý Tin tức</h3>
        &nbsp;&nbsp;&nbsp;Danh mục cấp 1&nbsp;<?php echo get_main_danhmuc();?>
	   &nbsp;&nbsp;&nbsp;&nbsp;<br/><br/>
...
<table class="blue_table">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
      ...
      <td style="width:10%;">
        ...
        <td style="width:10%;"><a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=edit&id_danhmuc=<?php echo @$items[$i]['id_danhmuc']?>&id_list=<?php echo @$items[$i]['id_list']?>&id_cat=<?php echo @$items[$i]['id_cat']?>&id_item=<?php echo @$items[$i]['id_item']?>&id=<?php echo @$items[$i]['id']?>" style="text-decoration:none;"><?php echo @$items[$i]['ten']?></a></td>
        ...
        <a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=man&noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_1.png" border="0" /></a>
		<?php }
		else
		{
		?>
         <a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=man&noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>     
        </td>
        ...
        <a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=man&hienthi=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_1.png" border="0" /></a>
		<?php }
		else
		{
		?>
         <a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=man&hienthi=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>      
        </td>
        
		<td style="width:5%;"><a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=edit&id_danhmuc=<?php echo @$items[$i]['id_danhmuc']?>&id_list=<?php echo @$items[$i]['id_list']?>&id_cat=<?php echo @$items[$i]['id_cat']?>&id_item=<?php echo @$items[$i]['id_item']?>&id_nhaphathanh=<?php echo @$items[$i]['nhaxuatban']?>&id_tacgia=<?php echo @$items[$i]['nhasanxuat']?>&id=<?php echo @$items[$i]['id']?>&p=<?php echo $_REQUEST['p']?>"><img src="media/images/edit.png" /></a></td>
		<td style="width:5%;"><a href="index.php?com=thuoctinh&loaitin=<?php echo $loaitin; ?>&act=delete&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
