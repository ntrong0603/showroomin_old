...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=place&act=chuyencap_cat&id_cat="+a.value;	
		return true;
	}
...
<?php	
	...
	{
		global $loaitin;
		$sql_huyen="select * from table_place_cat where loaitin='".$loaitin."' order by stt,id desc ";
	...
	{
		global $loaitin;
		$sql_huyen="select * from table_place_item where loaitin='".$loaitin."' order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
...
?>
<form name="frm" method="post" action="index.php?com=place&act=save_chuyencap_cat" enctype="multipart/form-data" class="nhaplieu">
    
     <b>Chọn danh mục cần chuyển:</b><?php echo get_main_cat();?><br /><br /> 
     <b>Chọn cấp chuyển:</b>
     ...
     <br /><br /> 
      <b>Chọn danh mục cần chuyển:</b><?php echo get_main_item();?><br /><br /> 
