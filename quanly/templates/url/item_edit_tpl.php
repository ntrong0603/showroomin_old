...
?>
<form name="frm" method="post" action="index.php?com=hinhanh&act=save&p=<?php echo $_REQUEST['p']?>" enctype="multipart/form-data" class="nhaplieu">	     
	<b>Album khách hàng:</b><?php echo get_main_item();?><br /><br />   
	<?php if ($_REQUEST['act']==edit)
	{?>
	<b>Hình hiện tại:</b><img src="<?php echo _upload_sanpham.$item['thumb']?>"  alt="NO PHOTO" /><br />
	<?php }?>
