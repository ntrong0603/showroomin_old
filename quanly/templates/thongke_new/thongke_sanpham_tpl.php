...
<div class='thongke_loc'>
	...
	<select id="id_danhmuc" name="danhmuc" onchange="select_onchange_danhmuc()" class="input">
		<option value="0" >Danh mục sản phẩm</option>
		<?php 
			if(isset($_GET['showroom']) && $_GET['showroom']!=0){
			$danhmuc=getItemSelect('table_product_danhmuc',' where id_place='.$_GET['showroom']);
			for($i=0;$i<count($danhmuc);$i++){?>
			
				<option value="<?php echo $danhmuc[$i]['id']; ?>" <?php if(isset($_GET['danhmuc']) && $_GET['danhmuc'] == $danhmuc[$i]['id']){ echo 'selected';}?>><?php echo $danhmuc[$i]['ten']; ?></option>
	...
	function select_onchange_concept(){
		var link='index.php?com=thongke&act=<?php echo $_GET['act']; ?>';
	...
	function select_TimKiem()
		{	
			...
			var nhasx=document.getElementById("id_nhasx");
			var showroom=document.getElementById("id_concept");
			var danhmuc=document.getElementById("id_danhmuc");
		...
		function xuatfile(){
			window.location='http://showroomin.com/quanly/templates/thongke_new/ajax_exSanPham.php';
		}
	</script>
</div>
...
<table class="blue_table">
	<tr>
        <th style="width:5%;">Stt</th>		
      	<th style="width:35%">Tên concept </th>
        <th style="width:15%"><a href='javascript:void()' class='sapxep' onclick="sapxep('<?php if(isset($_GET['sapxep']) && $_GET['sapxep']=='luotxem-tang'){
				echo 'luotxem-giam';
		...
		<th style="width:15%"><a href='javascript:void()' class='sapxep' onclick='sapxep("<?php if(isset($_GET['sapxep']) && $_GET['sapxep']=='luotdat-tang'){
				echo 'luotdat-giam';
			}else{
				echo 'luotdat-tang';
	...
	<tr>
		...
		<td style="width:12.5%;"><?php echo $items[$i]['tennhasx'] ?></td>
		<td style="width:12.5%;"><a href='<?php echo 'index.php?com=product&act=edit&id_place='.$items[$i]['place'].'&id='.$items[$i]['id'].'&id_danhmuc='.$items[$i]['danhmuc'] ?>' >Xem chi tiet</a></td>
	</tr>
	<?php }?>
</table>
