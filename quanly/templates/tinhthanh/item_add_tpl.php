...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if( isset($_REQUEST['id']) and $_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_danhmuc="+a.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if( isset($_REQUEST['id']) and $_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=place&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if( isset($_REQUEST['id']) and $_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_danhmuc="+a.value+"&id_list="+b.value+"&id_cat="+c.value;	
		return true;
	}
...
<div id='tab1' class='' > 
	<?php if ($capmenu>=1){ ?> <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /><?php } ?>
    <?php if ($capmenu>=2){ ?> <b>Danh mục cấp 2:</b><?php echo get_main_list();?><br /><br /><?php } ?>
    <?php if ($capmenu>=3){ ?> <b>Danh mục cấp 3:</b><?php echo get_main_category();?><br /><br /><?php } ?>
    <?php if ($capmenu>=4){ ?> <b>Danh mục cấp 4:</b><?php echo get_main_item();?><br /><br /><?php } ?>
    
    <?php if ($_REQUEST['act']==edit)
	{?>
	<b>Hình ảnh:</b><img src="<?php echo _upload_sanpham.$item['thumb']?>"  alt="NO PHOTO" width="200px;" /><br />
	<?php }?>
	<b>Chọn hình:</b> <input type="file" name="file" /> <?php echo _place_type?><br />
    <br />
    ...
    <div id='' class='' style='width: 100%; height: 100px; overflow:scroll;' > 
		...
		<a style="padding-left:5px;" href="index.php?com=hinhsp&act=man_photo&id_sp=<?php echo @$item['id']?>&id_mau=<?php echo $thuoctinh[$j]['id'];?>" > |  nhập hình </a>
    ...
    <b>Mã sp</b> <input type="text" name="kichthuoc" value="<?php echo @$item['kichthuoc']?>" class="input" /><br /> 
    ...
    <b>Nổi bật </b> <input type="checkbox" name="noibat" <?php echo ( $item['noibat']==1)?'checked="checked"':''?> /><br /> 
