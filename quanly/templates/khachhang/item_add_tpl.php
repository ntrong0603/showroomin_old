...
<form name="frm" method="post" action="index.php?com=khachhang&act=save&curPage=<?php echo $_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
  ...
  <?php if ($_REQUEST['act']==edit)
    ...
    <b>Tên </b> <input type="text" name="ten" value="<?php echo $item['ten']?>" class="input" /><br /> 
        <b>Username</b> <input type="text" name="username" value="<?php echo $item['username']?>" class="input" /><br />      
