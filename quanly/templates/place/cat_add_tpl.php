...
<?php	
	...
	{
		$sql_huyen="select * from table_place_category order by stt,id desc ";
	...
	{
		$sql_huyen="select * from table_place_category where id_danhmuc=".$_REQUEST['id_danhmuc']." order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
