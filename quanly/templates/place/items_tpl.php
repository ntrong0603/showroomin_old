...
$("#xoahet").click(function(){
	...
	hoi= confirm("Xóa Place sẽ đồng thời xóa hết Product trong Place. Bạn có chắc chắn muốn xóa?");
...
<table class="blue_table">
	<tr>
        ...
        <th style="width:5%;">Hình  </th>
         <th style="width:5%;">Hình trên bản đồ</th>
		 <th style="width:10%;">Quản lý danh mục</th>
  ...
  <td align="center" style="width:10%;"><a href="index.php?com=product&act=man_danhmuc&id_place=<?=@$items[$i]['id']?>"><img src="media/images/folder.png"  border="0" width="50px" /></a></td>
		<td align="center" style="width:10%;"><a href="index.php?com=product&act=man&id_place=<?=@$items[$i]['id']?>"><img src="media/images/folder.png"  border="0" width="50px" /></a></td>	
