...
$(document).ready(function() {
	$('.stt').focusout(function(){
		...
		$.ajax({
				...
				data:"idsp="+idsp+"&idstt="+idmaso+"&table=place_category",
				async:false,
				success:function(kq){
				}
		})
...
<form action style="margin: 20px 0px;" method="GET">
	...
	<a href="index.php?com=place&act=man_danhmuc" style="text-decoration: none; border:solid 1px #cccccc; padding:3px;">Reset</a>
</form>
<script>
...
<table class="blue_table">
	...
	<?php for($i=0, $count=count($items); $i<$count; $i++){
		...
		<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
			...
			<td style="width:5%;"><a href="index.php?com=place&act=edit_danhmuc&<?php 
...
?>	
		<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
			...
			<td style="width:5%;"><a href="index.php?com=place&act=delete_danhmuc&id=<?php echo @$sub[$j]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$sub[$j]['ten']?>')) return false;"><img src="media/images/delete.png" border="0" /></a></td>
		</tr>
<?php
		$d1=$d+2;
		if(!empty($sub[$j]['sub'])){ 
