<h3><a href="index.php?com=place&act=add">Thêm tin danh muc</a>
        &nbsp;&nbsp;&nbsp;Danh mục cấp 2&nbsp;<?php echo get_main_category();?></h3>
<script language="javascript">	
	function select_onchange()
	{
		var b=document.getElementById("id_list");
		window.location ="index.php?com=place&act=man_cat&id_list="+b.value;	
		return true;
	}
...
function get_main_category()
	{
		$sql="select * from table_place_list order by stt asc,id desc";
...
<table class="blue_table">
	...
	<tr>
		...
		<td align="center" style="width:15%;">
			<?php
			$sql_danhmuc1="select ten_vi from table_place_list0 where id='".$items[$i]['id_list_l']."'";
		 ...
		 <td align="center" style="width:15%;">
			<?php
			$sql_danhmuc1="select ten_vi from table_place_list where id='".$items[$i]['id_list']."'";
			$result=mysql_query($sql_danhmuc1);
			$item_danhmuc1 =mysql_fetch_array($result);
			echo @$item_danhmuc1['ten_vi'];
			?>  
		...
		<td style="width:5%;">
			<a href="index.php?com=place&act=edit_cat&id_list=<?php echo $items[$i]['id_list']?>&id=<?php echo $items[$i]['id']?>&id_list_l=<?php echo $items[$i]['id_list_l']?>">
				<img src="media/images/edit.png" border="0" />
			</a>
		</td>
		
		<td style="width:5%;">
			<a href="index.php?com=place&act=delete_cat&id=<?php echo $items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa')) return false;">
