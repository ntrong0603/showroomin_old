...
<?php	
	...
	{
		global $loaitin;
		$sql_huyen="select * from table_news_danhmuc  where loaitin ='".$loaitin."'  order by stt,id desc ";
...
<form name="frm" method="post" action="index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=save_list&id=<?php echo @$item['id']?>" enctype="multipart/form-data" class="nhaplieu">	    	    <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /> 
	...
	{?>
	<b>Hình ảnh đại diện:</b><img src="<?php echo _upload_tintuc.$item['thumb']?>"  alt="NO PHOTO" width="200px;" /><br />
	<?php }?>
    <b>Chọn hình đại diện:</b> <input type="file" name="file" /> png, jpg, jpeg<br />
    <br />
    <b>Title</b>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=man_list'" class="btn" />
</form>