...
?>
<form name="frm" method="post" action="index.php?com=place&act=save_cat&id=<?php echo @$item['id']?>" enctype="multipart/form-data" class="nhaplieu">			    	    <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /> 
