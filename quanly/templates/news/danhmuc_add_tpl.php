...
<form name="frm" method="post" action="index.php?com=news&loaitin=<?php echo $loaitin; ?>&act=save_danhmuc&id=<?php echo @$item['id']?>" enctype="multipart/form-data" class="nhaplieu">	
	...
	<?php }?>
	<b>Chọn hình đại diện:</b> <input type="file" name="file" /> <?php echo _news_type?><br />
    <br />
    ...
    <b>Bên trái Slider</b> <input type="checkbox" name="noibat" <?php echo ($item['noibat']==1)?'checked="checked"':''?>><br />
