...
<form name="frm" method="post" action="index.php?com=qc&act=save&curPage=<?php echo $_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
  ...
  <b>Nội dung</b><br/>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=qc&act=man'" class="btn" />
</form>