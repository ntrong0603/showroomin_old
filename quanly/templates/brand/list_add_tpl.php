...
<form name="frm" method="post" action="index.php?com=brand&act=save_list&id=<?php echo @$item['id'];?>" enctype="multipart/form-data" class="nhaplieu">	    	    <b>Danh mục cấp 1:</b><?php echo get_main_danhmuc();?><br /><br /> 
	...
	<div>
     ...
     <script language="javascript">CKEDITOR.rebrand('mota');</script> 
	...
	<div>
     ...
     <script language="javascript">CKEDITOR.rebrand('mota_sd');</script> 
     
    <b>Nội dung Tiếng Anh</b><br/>
	<div>
	  <textarea name="noidung_sd" id="noidung_sd"><?php echo @stripslashes($item['noidung_sd'])?></textarea></div> <br/>  
     <script language="javascript">CKEDITOR.rebrand('noidung_sd');</script> 
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=brand&act=man_list'" class="btn" />
</form>