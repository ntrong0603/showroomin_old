...
$("#xoahet").click(function(){
	...
	hoi= confirm("Xóa brand sẽ đồng thời xóa hết Product trong brand. Bạn có chắc chắn muốn xóa?");
	if (hoi==true) document.location = "index.php?com=brand&act=delete&listid=" + listid;
});
});
</script>
<h3>Quản lý Brand</h3>
		<?php $sodmuc=demdanhmuc(get_danhmucdacap($d,0)); $sodmuc=0;?>
	<?php 
		for($i=1;$i<=$sodmuc;$i++)
		{
	?>
...
<script language="javascript">				
	...
	$(document).ready(function(){   
		$('.kichthuoc').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/brand/ajax/ajaxkichthuoc.php",
		...
		$('.gia').focusout(function(){
			...
			$.ajax({
				type:"get",
				url:"templates/brand/ajax/ajaxgia.php",
				data:"idsp="+idsp+"&idstt="+idmaso,
				async:false,
				success:function(kq){
...
?>
<a href="index.php?com=brand&act=add"><img src="media/images/add.jpg" border="0"  /></a>
<br />
<table class="blue_table">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
        ...
        <td style="width:5%;"><a href="index.php?com=brand&act=edit&id=<?php echo @$items[$i]['id']?>" style="text-decoration:none;"><?php echo @$items[$i]['ten']?></a></td>
       ...
       <td align="center" style="width:5%;"><a href="index.php?com=hinhsp&act=man_photo&id_sp=<?php echo @$items[$i]['id']?>&id_com=<?php echo $_GET['com'];?>">Hình ảnh</a></td>
        ...
        <a href="index.php?com=brand&act=man&noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_1.png" border="0" /></a>
		<?php }
		else
		{
		?>
         <a href="index.php?com=brand&act=man&noibat=<?php echo @$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='. $_REQUEST['p'];?>"><img src="media/images/active_0.png"  border="0"/></a>
         <?php
		 }?>     
        </td>
        ...
        <a href="index.php?com=brand&act=man&<?php 
		...
		<td style="width:5%;"><a class='edit_item' href="index.php?com=brand&act=edit&<?php 
		...
		<td style="width:5%;"><a href="index.php?com=brand&act=delete&id=<?php echo @$items[$i]['id']?>" onClick="if(!confirm('Xác nhận xóa: <?php echo @$items[$i]['ten']?>')) return false;"><img src="media/images/delete.png" /></a></td>
	</tr>
	<?php	}?>
    </table>
<a href="index.php?com=brand&act=add"><img src="media/images/add.jpg" border="0"  /></a>
