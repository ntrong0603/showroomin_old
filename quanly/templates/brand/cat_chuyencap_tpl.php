...
<script language="javascript">				
	...
	{			
		...
		window.location ="index.php?com=brand&act=chuyencap_cat&id_cat="+a.value;	
		return true;
	}
...
<?php	
	...
	{
		$sql_huyen="select * from table_brand_cat order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=brand&act=save_chuyencap_cat" enctype="multipart/form-data" class="nhaplieu">
