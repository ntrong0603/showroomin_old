...
<form name="frm" method="post" action="index.php?com=cauhoithuonggap&act=save&curPage=<?php echo $_REQUEST['curPage']?>" enctype="multipart/form-data" class="nhaplieu">
...
<!--   <?php if ($_REQUEST['act']==edit)
    ...
    <b>Tên Câu Hỏi</b> <input type="text" name="ten_vi" value="<?php echo $item['ten_vi']?>" class="input" /><br />     
...
<!--     <b>Nội dung - English</b><br/>
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=cauhoithuonggap&act=man'" class="btn" />
</form>