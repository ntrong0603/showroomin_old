    ...
    <div class="container">
        <section>
            <div class="row pad5">
                <div class="col-lg-9">
                    <div class="post">
                        <h1> Nhà, đất bán khu vực <?php echo $title_ba;?></h1>
			
							
							<?php for($i=0; $i<count($place);$i++){?>
                        <div class="col-lg-6">
				<div class="item_nhadat">
          <div class="img_nhadat"><a class="" href="<?php echo get_tenkhongdau("table_tinhthanh_danhmuc",$place[$i]['id_tinh']);?>/<?php echo $place[$i]['tenkhongdau'];?>-ndb<?php echo $place[$i]['id'];?>.html" >
		  <img class="img-thongtin" src="./upload/sanpham/<?php echo $place[$i]['photo'];?>" alt="<?php echo $place[$i]['ten'];?>"></a></div>
          <div class="nd_nhadat">
          	<a class="" href="<?php echo get_tenkhongdau("table_tinhthanh_danhmuc",$place[$i]['id_tinh']);?>/<?php echo $place[$i]['tenkhongdau'];?>-ndb<?php echo $place[$i]['id'];?>.html" ><h2><?php echo $place[$i]['ten'];?></h2></a>
		  	<span class="label label-success size16"><?php echo $place[$i]['dientich'];?></span>
		  	<span class="label label-warning  size16">Giá <?php echo chuyentien($place[$i]['gia']);?></span>
		  	<div class="khuvuc"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span><?php echo $place[$i]['diadiem'].', '.diachi($place[$i]['id_tinh'],$place[$i]['id_huyen'],$place[$i]['id_phuong']);?></div>
		  	<div class="times"><?php echo "Ngày ".date("d",$place[$i]['ngaytao'])." tháng ".date("m",$place[$i]['ngaytao'])." năm ".date("Y",$place[$i]['ngaytao']);?></div><div class="clearfix"></div>
		  ...
		  <?php } ?>
			...
			<div <div class="row row-content duan_noibat">
              <div class="col-lg-12"><h1>Dự án nổi bật</h1></div>
              <div class="col-lg-6 duanhot1">
                <div class="vc_column-inner ">
              <div class="article_container">  
                <div class="duanbds">
                  <div class="img_duan"><img src="./images/can-ho-richmond-1.jpg" alt="dự án ABC"/> </div>
    
                  <div class="places_cover" data-link="http://rio.wpresidence.net/area/leblon/"></div>
                  <div class="places_type_2_content">
                    <span class="label label-success giaduan">Giá từ 2 tỷ</span>
          <span class="label label-primary khuvuc"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Quận 1</span>
                    <h4 class="tenduan"><a href="http://rio.wpresidence.net/area/leblon/">Leblon<span> - Leblon in Rio   4 Listings</span></a> </h4> 
          ...
          <div class="col-lg-6 duanhot">
              ...
              <div class="article_container">  
                <div class="duanbds">
                  <div class="img_duan"><img src="./images/can-ho-richmond-1.jpg" alt="dự án ABC"/> 
                  </div>
                  <div class="places_cover" data-link="http://rio.wpresidence.net/area/leblon/"></div>
                  <div class="places_type_2_content">
                    <span class="label label-success giaduan">Giá từ 2 tỷ</span>
          ...
          <div class="col-lg-6 duanhot">
              ...
              <div class="article_container">  
                <div class="duanbds">
                <div class="img_duan">
                  <img src="./images/can-ho-richmond-1.jpg" alt="dự án ABC"/> 
				  </div>
                  <div class="places_cover" data-link="http://rio.wpresidence.net/area/leblon/"></div>
                  <div class="places_type_2_content">
                    <span class="label label-success giaduan">Giá từ 2 tỷ</span>
          ...
          <div class="col-lg-6 duanhot">
              ...
              <div class="article_container">  
                <div class="duanbds">
                  ...
                  <div class="places_type_2_content">
                    <span class="label label-success giaduan">Giá từ 2 tỷ</span>
<span class="label label-primary khuvuc"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>Quận 1</span>                    <h4 class="tenduan"><a href="http://rio.wpresidence.net/area/leblon/">Leblon<span> - Leblon in Rio   4 Listings</span></a> </h4> 
