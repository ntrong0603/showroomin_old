...
function laydiadiem(str){
	$('#divform').prepend('<input type="hidden" name="'+$(str).parent().attr('cate')+'" value="'+$(str).attr('value')+'" id="catehide" /><input  type="text" class="form-control w20 catesearch search-left" id="'+$(str).parent().attr('cate')+'" value="'+$(str).attr('alt')+'"  readonly /><span id="closecate" ></span>');
	$("#textgoiy").hide();
...
<script>
	...
	break;
            ...
            <form action="search.html" method="GET" class="" name="search-form" id="search-form"  accept-charset="utf-8">
					...
					<div class="input-group my-group" id='divform' > 
						...
						<div id='' class=''  style='position: relative;'>  
						<input type="text" class="form-control w100 search-right" id='near' name='toado'  result="t-d" onkeyup="hienthidiadiem2(this.value)" placeholder="Vị trí: Quận 1 , Hồ Chí Minh" autocomplete="off"/>
							<div id='' class='clearfix' >  </div>
					   ...
					   <div id='' class='' >  
						<span class="input-group-btn w100 text-center">
							<button class="btn btn-default my-group-button" id='btn-submit' height='40' type="submit">Tìm kiếm</button>
						</span>
						 </div>
					</div>
