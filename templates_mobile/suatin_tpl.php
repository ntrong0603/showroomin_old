...
<div class="post-content">
    ...
    <form id="form_dang_tin" name="form_dang_tin" action="" method="post" target="post_target" enctype="multipart/form-data" >
        ...
        <table> 
         ...
         <tr>	        
            ...
            <td colspan="3">
                ...
                <input name="tieude" id="tieude" title="Tiêu đề từ 10 - 90 ký tự" maxlength="90" type="text" width="200" value="<?php echo $tin_edit['ten']?>" disabled="disabled">
         ...
         <tr>
            ...
            <td colspan="3">
                ...
                <textarea name="noidung" id="noidung" class="border_radius_dashed">
                <?php echo $tin_edit['noidung']?>
                </textarea>		            
            </td>
        </tr>	
         <tr>
            ...
            <td style="width:300px;">
                ...
                <option <?php if($loaitin['id'] == $thuoctinh[$i]['id']) echo 'selected="selected"'; ?>  value="<?php echo $thuoctinh[$i]['id']?>"><?php echo $thuoctinh[$i]['ten']?></option>
                <?php }?>
            </select>
            </td>
        ...
        <tr>
            ...
            <td><label class="require">Chưa chọn tỉnh</label><br>
	            ...
	            <?php
                    ...
                    <select id="id_tinh_tin" name="id_tinh_tin" class="main_font" onchange="load_huyen()">
                        ...
                        <option <?php if($tin_edit['id_tinh'] == $dm_tinh_tin[$i]['id']) echo 'selected="selected"'; ?> value="<?php echo $dm_tinh_tin[$i]['id']?>" ><?php echo $dm_tinh_tin[$i]['ten']?></option>
                        <?php }?>	
                     </select>
            </td>            
            ...
            <td>
                ...
                ?>
                    <option  <?php if($tin_edit['id_huyen'] == $huyenchon[$i]['id']) echo 'selected="selected"';?> value="<?php echo $huyenchon[$i]['id']?>" ><?php echo $huyenchon[$i]['ten']?></option>
					<?php	
                    }
                    ?>
            </td>
         ...
         <tr>
            ...
            <td colspan="3"><label class="require">Chưa chọn phường/xã</label><br>
                <input name="diachi" id="diachi" maxlength="120" placeholder="Số nhà 21/32" type="text" value="<?php echo $tin_edit['diachi']?>">	            
				
	            <select name="id_phuong_tin" id="id_phuong_tin" class="search_select">
                    <option value="">--------- Phường/Xã ---------</option>
                <?php
				$d->reset();
                    $sql="select * from table_tinhthanh_cat where id_list = '".$tin_edit['id_huyen']."' order by stt";
                    $d->query($sql);
                    $phuongchon = $d->result_array();
					for($i=0;$i<count($phuongchon);$i++){
				?>
                <option  <?php if($tin_edit['id_phuong'] == $phuongchon[$i]['id']) echo 'selected="selected"';?> value="<?php echo $huyenchon[$i]['id']?>"  ><?php echo $phuongchon[$i]['ten']?></option>
                <?php }?>
                </select>	  
		        <div class="suggesstion">	        
	                <ul>
        ...
        <tr>
            ...
            <td colspan="3">
                <select name="id_duan" id="id_duan" class="search_select">
                    ...
                    <?php
				$d->reset();
                    $sql="select * from table_news where hienthi = 1 and loaitin = 'duan' and id_huyen = '".$tin_edit['id_huyen']."' order by stt";
                    $d->query($sql);
                    $duanchon = $d->result_array();
					for($i=0;$i<count($duanchon);$i++){
				?>
                <option  <?php if($tin_edit['id_duan'] == $duanchon[$i]['id']) echo 'selected="selected"';?> value="<?php echo $huyenchon[$i]['id']?>"  ><?php echo $duanchon[$i]['ten']?></option>
                <?php } ?>
                </select>		
        ...
        <tr>
            ...
            <td width="300px">
	            ...
	            <input name="gia" id="gia" class="dientich" maxlength="10" onkeyup="getTextPrice(this.value);" onblur="getTextPrice(this.value);" title="Chú ý: 1 = 1.000.000 VNĐ" type="text" value="<?php echo $tin_edit['gia']?>">			   
	            <select name="donvi" id="donvi">
                    <option <?php if($tin_edit['donvi'] == 0) echo 'selected="selected"';?> value="0">tổng diện tích</option>
                    <option <?php if($tin_edit['donvi'] == 1) echo 'selected="selected"';?> value="1">m&sup2;</option>
                </select>
            ...
            <td>	
        	    ...
        	    <input name="dientich" id="dientich" class="dientich" maxlength="9" type="text" 
                value="<?php echo $tin_edit['dientich']?>">m<sup>2</sup>	
        	    <div class="suggesstion">	        
	                <ul>
        ...
        <table cellpadding="0px" cellspacing="4px">		      		    
            <tbody><tr>			    
                ...
                <td style="width:160px">
                    ...
                    <input name="chieungang" id="chieungang" class="dientich" maxlength="8" type="text" 
					value="<?php echo $tin_edit['rong']?>">m
                </td>
                <td>Chiều dài</td>
                <td>
                    <label class="require">Chỉ nhập số</label>
                    <input name="chieudai" id="chieudai" class="dientich" maxlength="8" type="text" value="<?php echo $tin_edit['dai']?>">m
                </td>
                ...
                <td>
                    <select name="huong" id="huong">
						...
						<?php
                                    ...
                                    <option <?php if($huong['id'] == $thuoctinh[$i]['id']) echo 'selected="selected"'; ?>  value="<?php echo $thuoctinh[$i]['id']?>"><?php echo $thuoctinh[$i]['ten']?></option>
                                    <?php }?>
                    </select>
                </td>
                <td style="width:110px">Đường rộng</td>
                <td style="width:160px">
	                <input  name="duongrong" id="duongrong" class="dt" maxlength="3" type="text" value="<?php echo $tin_edit['drong']?>">m
                </td>
            ...
            <tr>
                ...
                <td>
	                <select name="phaply" id="phaply">
						...
						<option <?php if($phaply['id'] == $thuoctinh[$i]['id']) echo 'selected="selected"'; ?>  value="<?php echo $thuoctinh[$i]['id']?>"><?php echo $thuoctinh[$i]['ten']?></option>
						<?php }?>
                    </select>
                </td>
                <td>
            ...
            <tr>
                <td>Số lầu</td>
                <td colspan="3">
	                <input name="solau" id="solau" class="dt" maxlength="3" type="text" value="<?php echo $tin_edit['solau']?>">
	                <label class="require">Chỉ nhập số</label>
                </td>		    
            ...
            <tr>							
                <td>Số phòng ngủ</td>
                <td colspan="3">
	                <input name="sophongngu" id="sophongngu" class="dt" maxlength="3" type="text" value="<?php echo $tin_edit['sophong']?>">
	                <label class="require">Chỉ nhập số</label>
                </td>
        ...
        <div>
            <div class="item">
                <div>
                    ...
                    <img src="<?php echo _upload_sanpham_l.$tin_edit['thumb']?>" style="width:100%;"/>
                    <label for="img1">
            ...
            <div class="item">
                <div>
                    <div class="filename"></div>
                     <img src="<?php echo _upload_sanpham_l.$hinh[0]['thumb']?>" style="width:100%;"/>
                    <label for="img2">
            ...
            <div class="item">
                <div>
                    <div class="filename"></div>
                     <img src="<?php echo _upload_sanpham_l.$hinh[1]['thumb']?>" style="width:100%;"/>
                    <label for="img3">
    ...
    <div class="clear"></div>  
    <div class="control">
    <input type="button"  class="btn_search" value="Sữa tin" onclick="js_submit();" ></input>
