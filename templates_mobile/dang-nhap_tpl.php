...
<div class="clearfix"></div><div class="hei7"></div>
   ...
   <div class="col-md-9" >
   		<div class="bar"><a href="index"> <?php echo _trangchu?> > </a> <h1> &nbsp; <?php echo _dangnhap?></h1></div>
            ...
            <div class="tieude_dang sss"><?php echo _thongtindangnhap?></div>
            	 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" data-minlength="6"  class="form-control" id="password1" name="password1" placeholder="Password" required="required">
