 ...
 <div class=" container">
            <div class="row ">
				<div id='' class='main-user col-sm-8 col-md-offset-2 no-padding' >  
				...
				<div class="tab-content login">
				  <div id="dang-nhap" class="tab-pane fade in <?php if( $act=='login' ){echo "active"; } ?>">
						 <form method="post" name="frm" action="./user/login.html" autocomplete=off >
								...
								<img src='./images/icon-user.svg' alt='' title='' />
								<div id='' class='blank-40' >  </div>
								</div>
								...
								<div class="form-group text-center">
								  ...
								  <input type="submit" style='float: none;margin-top: 10px;' name='dangnhap' class=" btn-dangnhap" value="Đăng nhập"/>
				  ...
				  <div id="dang-ky" class="tab-pane fade in <?php if( $act=='register' ){echo "active"; } ?>">
							 <form method="post" name="frm" action="./user/register.html" >
									...
									<div class="form-group text-center">
									  <input type="submit" style='margin-top: 10px;float: none;' name='dangky' class="btn-dangnhap" value="Đăng ký"/>
									  </div>
