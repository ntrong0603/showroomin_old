...
<div class="container">
	...
	<div class="gianhang">
		...
		<div class="col-xs-12 gianhang3" style="padding: 0px;position:relative;">
			<div class="col-md-6 " style="line-height: 25px;position: relative;height: 350px;padding: 16px 28px;">
			...
			<div class="col-xs-6" style="background-color: #f5f5f5; height: 365px; padding: 16px 28px;">
	...
	if(count($result_cart)>0){
		$result_gioh.="<div class='fix-scorll-ball' style='overflow: auto; height: 200px;'>";
		for($i_gioh=0; $i_gioh<count($result_cart); $i_gioh++){
			...
			$result_gioh.="<div class='col-md-6' style='font-size: 14px;color: #252525;padding: 0px;'>".$item['ten']."</div>";
			$result_gioh.="<div class='col-md-1' style='font-size: 14px;color: #252525;padding: 0px'>".$result_cart[$i_gioh]['qty']."</div>";
			$result_gioh.="<div class='col-md-5' style='font-size: 12px;color: #ff0000;font-weight: 500;padding: 2px 0px;'>".number_format($new_price,0,'','.')." VNĐ.";
			if($item['khuyenmai']>0){
			$result_gioh.="<div>";
...
?>
				...
				<div class='form_dathang'>
					<form>
						<div style='width: max-content;margin: auto;;'><input type="button" class="dathang2" name="dathang" value="Đặt hàng"></div>
					</form>
				</div>
				<?php }?>
				<div class="clearfix"></div>
