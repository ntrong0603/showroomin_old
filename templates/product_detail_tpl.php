 <!--planning-->
	        ...
	        <div class="container">
                <section>
                	<div class="row pad5">
	                	<div class="col-lg-9">
                    		<div class="headduan">
                    		<h1>Căn hộ Saigon Mia <?php echo $chitietsanpham['ten'];?></h1>
		                        	<p>Khu vực: Quận 7, TP.HCM</p>
		                        	<span class="label label-warning">Giá từ 2 tỷ</span>
		                        </div>
                        	<div class="hinhanh">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:370px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/sp/001.jpg" />
                <img data-u="thumb" src="img/sp/001-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/002.jpg" />
                <img data-u="thumb" src="img/sp/002-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/003.jpg" />
                <img data-u="thumb" src="img/sp/003-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/004.jpg" />
                <img data-u="thumb" src="img/sp/004-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/005.jpg" />
                <img data-u="thumb" src="img/sp/005-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/006.jpg" />
                <img data-u="thumb" src="img/sp/006-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/007.jpg" />
                <img data-u="thumb" src="img/sp/007-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/008.jpg" />
                <img data-u="thumb" src="img/sp/008-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/009.jpg" />
                <img data-u="thumb" src="img/sp/009-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/010.jpg" />
                <img data-u="thumb" src="img/sp/010-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/011.jpg" />
                <img data-u="thumb" src="img/sp/011-s200x100.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/sp/012.jpg" />
                <img data-u="thumb" src="img/sp/012-s200x100.jpg" />
            </div>
            ...
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                ...
                <line class="a" x1="5426.1" y1="8000" x2="10573.9" y2="8000"></line>
	                        	...
	                        	<div class="col-lg-12 info_duan">
		                        	...
		                        	<div class="moreinfo">Thông tin thêm ABC</div>
...
<div class="wpcf7-response-output wpcf7-display-none"></div></form>
								...
								b<br/>
								b<br/>
                                 <?php echo stripslashes($chitietsanpham['noidung']);?>
                                ...
                                <div class="tabbable" id='lichtrinh' style="margin-bottom: 9px;">
											<ul class="nav nav-tabs">
												...
												<li class="vitri"><a href="#nhadautu" data-toggle="tab">Nhà đầu tư</a></li>
